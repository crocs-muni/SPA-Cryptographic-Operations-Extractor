...
public class EuclideanDistanceTest {
    ...
    private final int mesh = 1;
    
    public EuclideanDistanceTest() throws IOException {
    ...
    public void realDataTest_compareWithPrecomputedDistance() {
        EuclideanDistance distanceAlgorithm = new EuclideanDistance();
        double expResult = 353;
