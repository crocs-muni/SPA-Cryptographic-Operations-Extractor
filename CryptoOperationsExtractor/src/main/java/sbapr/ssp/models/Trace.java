...
public class Trace {
    /**
     * Constant used for getting sampling frequency, multiplier that is used to convert milliseconds to seconds.
     */
    private static final int TIME_UNIT_CONSTANT = 1000;
    /**
     * Voltage array, values in this array may not be unique.
     */
    private final double[] voltageArray;
    /**
     * Time array, values in this array must be unique.
     */
    private final double[] timeArray;
    /**
     * This attribute holds number of pairs (time, voltage) in the trace.
     */
