...
/**
 * This class contains static methods used for plotting charts.
 * 
...
public class ChartManager {
    ...
    /**
     * This method should be used only when @param chartPanel already filled by method @link this.plotChart(Trace trace).
     ...
     */
    public static ChartPanel plotChart(ChartPanel chartPanel, Collection<Boundaries> delimitingOperations, Collection<Boundaries> newOperations, String newOperationText) {
    ...
    public static ChartPanel plotChart(ChartPanel chartPanel, Collection<Boundaries> operations) {
        XYPlot plot = chartPanel.getChart().getXYPlot();
